package by.nehayonak.lol.xmlParser;
...
public class StaxStreamProcessor implements AutoCloseable{
    ...
    {
        try (StaxStreamProcessor processor = new StaxStreamProcessor(Files.newInputStream(Paths.get("F:\\Прога\\2 курс\\2_сем\\Java\\Labs\\Lab03\\files\\booklist.xml")))) {
            XMLStreamReader reader = processor.getReader();
            while (processor.startElement(element, "Office"))
